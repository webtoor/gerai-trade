...
<div class="limiter">
    <div class="container-login100">
        <div class="login100-more" style="background-image: url('images/bgs-01.jpg');"></div>
        ...
        <div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
            <form class="login100-form validate-form" method="POST" action="{{ route('register') }}">
                ...
                <div class="wrap-input100 validate-input" data-validate="Nama depan harus diisi!">
                    ...
                    <input class="input100 @error('nama_depan') is-invalid @enderror" type="text" name="nama_depan"
                ...
                <div class="wrap-input100 validate-input" data-validate="Nama belakang harus diisi!">
                    ...
                    <input class="input100 @error('nama_belakang') is-invalid @enderror" type="text"
...
<div class="card-body">
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="name" type="text" class="form-control @error('nama_depan') is-invalid @enderror"
                    name="nama_depan" value="{{ old('nama_depan') }}" required autocomplete="name" autofocus>
